...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , auto_adjust_replication_for_tablet_based_system_keyspaces(this, "auto_adjust_replication_for_tablet_based_system_keyspaces", value_status::Used, true, "Automatically adjust the replication settings for system keyspaces that use tablets. Should be disabled only for testing purposes.")
    , tablet_balancing_for_system_keyspaces(this, "tablet_balancing_for_system_keyspaces", value_status::Used, true, "Enable tablet load balancing for internal/system keyspaces. Can be disabled for testing purposes to avoid conflicts between system tablet migrations and test DDL operations.")
